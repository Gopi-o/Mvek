...
export const BFF = {
    getProduct(id, clientType = 'desktop') {
        ...
        switch(clientType) {
            case 'mobile': return mobileAdapter(product);
            case 'list': return listAdapter(product);
            case 'desktop': 
            default: return desktopAdapter(product);
        }
    },
    ...
    getAllProducts(clientType = 'desktop') {
        ...
        switch(clientType) {
            case 'mobile': return products.map(mobileAdapter);
            case 'list': return products.map(listAdapter);
            case 'desktop': 
            default: return products.map(desktopAdapter);
        }
    },
    ...
    getByCategory(category, clientType = 'desktop') {
        ...
        switch(clientType) {
            case 'mobile': return filtered.map(mobileAdapter);
            case 'list': return filtered.map(listAdapter);
            default: return filtered.map(desktopAdapter);
        }
    },
