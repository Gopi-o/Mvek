...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'VR-Shop'); ?></title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('catalog.index')); ?>">Каталог</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('compare.index')); ?>">Сравнение</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('pages.about')); ?>">О нас</a></li>
                </ul>
                <ul class="navbar-nav">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <?php if(!Auth::user()->is_admin): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('orders.index')); ?>">Мои заказы</a></li>
                                <?php endif; ?>
                    ...
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="<?php echo e(route('cart.index')); ?>" id="cart-toggle" title="Корзина">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li><a href="<?php echo e(route('catalog.index')); ?>" class="text-white text-decoration-none d-block py-1">Каталог</a></li>
                        <li><a href="<?php echo e(route('compare.index')); ?>" class="text-white text-decoration-none d-block py-1">Сравнение</a></li>
                        <li><a href="<?php echo e(route('cart.index')); ?>" class="text-white text-decoration-none d-block py-1">Корзина</a></li>
                        <li><a href="<?php echo e(route('pages.about')); ?>" class="text-white text-decoration-none d-block py-1">О компании</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
                    <h6 class="text-uppercase small text-white-50">Информация</h6>
                    <ul class="list-unstyled mb-0">
                        <li><a href="<?php echo e(route('pages.delivery')); ?>" class="text-white text-decoration-none d-block py-1">Доставка и оплата</a></li>
                        <li><a href="<?php echo e(route('pages.vr-games')); ?>" class="text-white text-decoration-none d-block py-1">Подборка VR-игр</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#faq" class="text-white text-decoration-none d-block py-1">FAQ</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#contact" class="text-white text-decoration-none d-block py-1">Контакты</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-0">
                    ...
                    <div id="cart-empty" class="text-center py-5 bg-light">
                        ...
                        <a href="<?php echo e(route('catalog.index')); ?>" class="btn btn-outline-primary btn-sm px-4">
                    ...
                    <div id="cart-items" style="display: none;">
                        ...
                        <div class="p-3 border-top bg-white">
                            ...
                            <div class="d-grid gap-2">
                                <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-success btn-lg py-2 fs-6 fw-bold">
    ...
    <script>
        let cartItems = <?php echo json_encode($cartItems ?? [], 15, 512) ?>;
...
<?php /**PATH E:\Suorce\VS_CODE\WEB\Mvek\resources\views/layouts/app.blade.php ENDPATH**/ ?>