<?php $__env->startSection('title', 'О нас | VR-Shop'); ?>
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="ratio ratio-16x9 rounded overflow-hidden shadow">
                    <img src="<?php echo e(asset('storage/img/about-vr.jpg')); ?>" class="w-100 h-100 object-fit-cover" alt="VR команда">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Suorce\VS_CODE\WEB\Mvek\resources\views/pages/about.blade.php ENDPATH**/ ?>