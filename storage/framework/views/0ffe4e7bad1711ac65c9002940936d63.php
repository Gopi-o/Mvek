<?php $__env->startSection('title', 'Доставка и оплата | VR-Shop'); ?>
        ...
        <div class="row g-4">
            <div class="col-lg-7">
                ...
                <ul class="text-muted">
                    ...
                    <li>Наличные курьеру (только Москва/СПб).</li>
                </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Suorce\VS_CODE\WEB\Mvek\resources\views/pages/delivery.blade.php ENDPATH**/ ?>